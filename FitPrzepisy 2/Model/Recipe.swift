...
struct Recipe: Codable, Identifiable {
    ...
    static let example = Recipe(id: "example", name: "This is example recipe", category: Category.breakfast, tag: ["Śniadanie", "Kurczak", "Papryka"], isFeatured: false, details: Recipe.Details(level: 1, preparationTime: 45, totalTime: 60, servings: 3) , ingredients: [Ingredient(ingredient: "Bułka", amount: 0.5, unit: "gram"), Ingredient(ingredient: "Pomarańcze", amount: 2, unit: "sztuki")], preparation: ["Bułkę/chleb pokrój i zapiecz na grzanki (można też skropić je lekko oliwą).", "Awokado (musi być dojrzałe) rozgnieć widelcem ze szczyptą soli, pieprzem i sokiem z cytryny.", "Na chleb nałóż pastę z awokado, na nią pokrusz ser feta (albo pokrój, ale ja zawsze go kruszę, dla mnie to wygodniejsze i ładniej wygląda), a na to ulubione dodatki.", "Posyp świeżo mielonym pieprzem i podawaj z pokrojonymi pomidorkami koktajlowymi."], macro: Recipe.Macro(kcal: 100, carbohydrates: 100, protein: 100, fat: 100))
}

//["level": 2, "preparationTime": 15, "totalTime": 25, "servings": 3]
